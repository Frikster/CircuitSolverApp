    ...
    public void onDraw(Canvas canvas, Paint paint,
        ...
        if (p1.getX() == p2.getX()) {
            ...
            for (int i=0; i < numSpikes; i++) {
                if (i == 0) {
                    canvas.drawLine(spikeStart.getX(), spikeStart.getY() - (interval * i),
                            spikeStart.getX() + (disp * (-1)^i), spikeStart.getY() +
                                    (interval * (i+1)), paint);
                } else if (i == (numSpikes - 1)) {
                    canvas.drawLine(spikeStart.getX() + disp, spikeStart.getY() - (interval * i),
                            spikeStart.getX(), spikeStart.getY() - (interval * (i+1)), paint);
                } else if (i % 2 == 0) {
